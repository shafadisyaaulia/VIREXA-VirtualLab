...
export default function VirtualLabPage() {
  ...
  return (
    <div className="h-screen bg-[#f8f9ff] text-[#0b1c30] flex flex-col font-sans selection:bg-indigo-100 selection:text-indigo-900 overflow-hidden">
      ...
      {/* Top AppBar */}
      <header className="flex justify-between items-center w-full px-4 py-2.5 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 shadow-sm shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:flex gap-4 ml-6 items-center text-xs font-bold text-slate-400">
            <span className="text-indigo-600 border-b-2 border-indigo-600 pb-0.5">🧪 Meja Eksperimen Virtual</span>
          </div>
        </div>
